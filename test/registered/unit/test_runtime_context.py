...
class TestBuffers(unittest.TestCase):
    ...
    def test_get_buffer_allocates_once_and_caches(self):
        store = BufferStore()
        store.register(_ws_spec())
        self.assertIs(store.get_buffer("t.ws"), store.get_buffer("t.ws"))
    ...
    def test_release_reallocates(self):
        ...
        store.release()
        self.assertEqual(store._cache, {})
        self.assertIsNot(a, store.get_buffer("t.ws"))
...
class TestFromModelRunner(unittest.TestCase):
    ...
    def test_reads_engine_attention_and_use_mla(self):
        ...
        getters = {
            ...
            "get_local_attention_dp_size": 1,
            "get_local_attention_dp_rank": 0,
        }
